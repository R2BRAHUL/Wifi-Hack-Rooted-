...
print('''
\033[1;92m WRITED BY E24 
Cyber7F_BD
Contact on whatsapp: +966 571217149
One line Command:\nsudo python Wifi_Hack/Wifi-7F.py -i wlan0 -K\n
For Help Type:\npython Wifi_Hack/Wifi-7F.py --help\033[0m
''')
...
class Companion:
    ...
    def __init__(self, interface, save_result=False, print_debug=False):
        ...
        self.sessions_dir = f'{user_home}/.Cyber7F_BD/sessions/'
        self.pixiewps_dir = f'{user_home}/.Cyber7F_BD/pixiewps/'
    ...
    def __prompt_wpspin(self, bssid):
        ...
        if len(pins) > 1:
            ...
            for i, pin in enumerate(pins):
                ...
                print(line)
            while 1:
                pinNo = input(C.CYAN + 'Select the PIN ➜ ' + C.RESET)
                try:
...
class WiFiScanner:
    ...
    def iw_scanner(self) -> Dict[int, dict]:
        ...
        print(C.GREEN + "\n[ Cyber7F‑BD ] Available WPS Networks\n" + C.RESET)
    ...
    def prompt_network(self) -> str:
        ...
        while 1:
            try:
                networkNo = input(C.CYAN + 'Select target ➜ ' + C.RESET)
...
def usage():
    return """
OneShotPin 0.0.2 (c) 2017 rofl0r, modded by Cyber7F_BD
...
if __name__ == '__main__':
    ...
    parser = argparse.ArgumentParser(
        description='OneShotPin 0.0.2 (c) 2017 rofl0r, modded by Cyber7F_BD',
